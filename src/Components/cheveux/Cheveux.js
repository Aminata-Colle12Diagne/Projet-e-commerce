...
import mcheveux10 from '../assets/img/cheveux 10.jpg'
import mcheveux11 from '../assets/img/cheveux 11.jpg'
import mcheuveux from '../assets/img/cheuveaux.jpg'
...
<div className="row rowCheveux" style={{marginTop: "10%"}}>
<div className='tous' style={{ marginTop: "2rem"}}>
   <h2 className='text-white'>Soins Cheveux Naturels</h2>
   </div>
</div>
...
<img src={mcheuveux} alt="" style={{width: "30rem", height: "25rem",marginLeft: "2rem"}}/>
</div>
</div>
